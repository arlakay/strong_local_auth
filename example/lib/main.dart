...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _authenticateWithStrongBiometrics() async {
    bool authenticated = false;
    try {
      setState(() {
        _isAuthenticating = true;
                ...
                if (_isAuthenticating)
                  ...
                  Column(
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        onPressed: _authenticateWithStrongBiometrics,
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: <Widget>[
                            Text(_isAuthenticating ? 'Cancel' : 'Authenticate: biometrics only & strong mode'),
                            const Icon(Icons.fingerprint),
                          ],
                        ),
                      ),
